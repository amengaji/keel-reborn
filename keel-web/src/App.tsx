...
/**
 * App Component
 * Root navigation controller for the Keel Admin Dashboard.
 * * UX DECISION: Routes are grouped by role permissions to ensure security.
 * * FIX: Standardized TRB Viewer to use /trainee-trb/:id for database consistency.
 */
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<DashboardLayout />}>
            ...
            {/* Master & CTO also need access to these for fleet-wide drill-down */}
            <Route element={<ProtectedRoute allowedRoles={['ADMIN', 'SHORE_ADMIN', 'MANAGER', 'SUPERINTENDENT', 'SHORE_OFFICER', 'MASTER', 'CTO']} />}>
                ...
                {/* ✅ STANDARDIZED ROUTE 
                   Uses :id to match DB primary keys. Obsolete :cadetName route removed 
                   to prevent navigation errors in the Digital Logbook.
                */}
